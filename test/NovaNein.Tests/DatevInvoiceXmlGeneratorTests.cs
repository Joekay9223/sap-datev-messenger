...
public class DatevInvoiceXmlGeneratorTests
{
 ...
 [Fact] public void Normalizes_source_invoice_numbers_to_datev_p10040(){ Assert.Equal("FIE-EXAMPLE", DatevInvoiceXmlGenerator.NormalizeInvoiceId(" FIE 83/IE ")); var xml = DatevInvoiceXmlGenerator.CreateIncoming(new(900458,"FIE 83/IE",new DateOnly(2026,7,8),"Testlieferant GmbH","IT000000001","Straße 1","12345","Ort","DE","Test",66600,66600,0,0,"EUR","3320","0",BusinessPartnerAccountNumber:"70001")); Assert.Contains("invoice_id=\"FIE-EXAMPLE\"", xml); }
